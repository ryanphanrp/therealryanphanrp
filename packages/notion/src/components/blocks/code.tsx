...
export function CodeBlock({ block, defaultLanguage = "text", ...props }: CodeBlockProps): React.ReactElement {
  ...
  return (
    <div className="code-block__wrapper mb-4">
      <div className="code-block_header bg-primary border-primary flex w-full justify-between border border-b-0 px-4 text-sm">
        <div className="code-language text-primary-foreground">{language}</div>
        <Button
          variant="ghost"
          className="code-copy-button text-primary-foreground h-5 px-2 py-0.5 hover:bg-transparent hover:text-white hover:underline"
